export default {
  ...
  alert_matrix: {
    ...
    baseline_factor: 'Baseline factor (N×)',
    quorum_label: 'Quorum',
    quorum_any: 'Any probe down',
    quorum_all: 'All probes down',
    latency_mode_label: 'Sensitivity',
    latency_mode_absolute: 'Fixed threshold',
    latency_mode_relative: '7-day baseline',
    ...
    conditions: {
      availability: 'A quorum of probes report the monitor down',
      ssl_expiry: 'SSL certificate expiring soon',
      latency_anomaly: 'Abnormal response time (fixed threshold, baseline, or z-score)',
  ...
  alerts: {
    ...
    cond_availability: 'Alert on a quorum of probes down (any, or all for a global outage)',
    cond_ssl_expiry: 'SSL certificate expiring soon',
    cond_latency_anomaly: 'Abnormal response time (fixed threshold, 7-day baseline, or z-score)',
    cond_schema_drift: 'API schema drift',
    cond_short_availability: 'Availability',
    cond_short_ssl_expiry: 'SSL expiry',
    cond_short_latency_anomaly: 'Latency anomaly',
    cond_short_schema_drift: 'API schema drift',
    quorum_label: 'Quorum',
    quorum_any: 'Any probe down',
    quorum_all: 'All probes down (global outage)',
    quorum_help: '"Any" pages as soon as one probe reports the monitor down. "All" only pages once every probe agrees — lower noise, but no signal on a partial/regional outage.',
    latency_mode_label: 'Sensitivity',
    latency_mode_absolute: 'Fixed threshold',
    latency_mode_relative: '7-day baseline',
    latency_mode_statistical: 'Z-score',
