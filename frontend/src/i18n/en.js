export default {
  ...
  alerts: {
    ...
    escalation_policy_hint: 'Pages the ladder in order until someone acknowledges — a single-rung, repeating policy is also how to "keep re-alerting on the same channels every N minutes". If it never reaches anyone, the alert falls back to the channels below — attaching a policy never makes a rule quieter.',
