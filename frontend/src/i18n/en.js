export default {
  ...
  settings: {
    ...
    extension_install_step3: 'Open <strong>chrome://extensions</strong> in Chrome (or <strong>edge://extensions</strong> in Edge).',
    extension_install_step4: 'Enable <strong>Developer mode</strong> (top-right toggle).',
    extension_install_step5: 'Click <strong>Load unpacked</strong> and select the unzipped folder.',
