export default {
  ...
  bulk: {
    ...
    bar_aria: 'Bulk actions',
  },

  wizard: {
    step_type: 'Type',
    step_target: 'Target',
    step_notifications: 'Review',
    back: 'Back',
    next: 'Next',
    pick_type_hint: 'Select a check type to continue.',
    advanced_link: 'Need a different type? Use the advanced form →',
    opens_advanced: 'Opens the advanced form',
    review_title: 'Review your monitor',
  },

  silences: {
    title: 'Alert silences',
    subtitle: 'Mute alert dispatch for a bounded window',
    add: 'New silence',
    name_placeholder: 'e.g. cert renewal',
    reason: 'Reason (optional)',
    reason_placeholder: 'context for your future self',
    scope_label: 'Scope',
    scope_all: 'All my monitors',
    starts_at: 'Starts at',
    ends_at: 'Ends at',
    badge_active: 'Active',
    badge_scheduled: 'Scheduled',
    badge_past: 'Past',
    empty_title: 'No silences yet',
    empty_text: 'Create a silence to mute alerts during a known-noisy event without skewing uptime.',
    create_success: 'Silence created',
    delete_success: 'Silence removed',
    confirm_delete_title: 'Delete this silence?',
    confirm_delete_message: 'Alerts for "{name}" will resume immediately.',
  },
  ...
  hotkeys: {
    ...
    go_monitors: 'Go to monitors',
    go_incidents: 'Go to incidents',
    go_alerts: 'Go to alerts',
    go_probes: 'Go to probes',
    go_settings: 'Go to settings',
    open_palette: 'Open command palette',
    create_monitor: 'New monitor',
  ...
  empty: {
    ...
    groups_text: 'Groups bundle monitors into a single status page. Create one to share publicly.',
    alerts_channels_text: 'Channels are where alerts land — email, Slack, webhook, etc. Add one before creating rules.',
    alerts_events_text: 'No alert events yet. Once a rule fires, the timeline will show up here.',
    probes_text: 'Probes run the actual checks. Register one in the cloud or self-host with Docker.',
    maintenance_text: 'Schedule a maintenance window to silence alerts during planned downtime.',
    incidents_text: 'Incidents open automatically when a monitor goes down. Nothing to see yet — that’s a good sign.',
    incidents_filtered_text: 'No incident matches the current filters.',
    audit_text: 'Every change made in WhatIsUp — by you or your teammates — will show up here.',
  ...
  detection_alert: {
    ...
    create_error: 'Error creating the alert rule',
  },
  ...
  dashboard: {
    ...
    hero_loading: 'One moment',
    hero_ok_1: 'Everything is',
    hero_ok_2: 'operational.',
    hero_down_pre: '{n} service | {n} services',
    hero_down_em: 'in trouble.',
    lede_ok: '{monitors} services monitored, {probes} active probes — all clear.',
    lede_down: '{n} open incident — alerts dispatched. | {n} open incidents — alerts dispatched.',
    services: 'Services',
    stat_services: 'services',
    stat_online: 'online',
    stat_trouble: 'in trouble',
    stat_uptime: '24 h availability',
    pill_up: 'online',
    pill_down: 'incident',
  ...
  monitors: {
    ...
    bulk_deleted_pending: '{count} monitor(s) removed',
    bulk_delete_undone: '{count} monitor(s) restored',
    bulk_success_grouped: '{count} monitor(s) moved',
    bulk_success_tagged: '{count} monitor(s) tagged',
    bulk_move_group: 'Move to group',
    ...
    dns_nameservers: {
      ...
      desc: 'Use specific DNS servers instead of system default (bypasses cache). E.g. 8.8.8.8, 1.1.1.1',
    ...
    bulk_export_success: '{count} monitor(s) exported as CSV',
    export_json: 'Export',
    import_json: 'Import',
    export_json_success: 'Monitors exported successfully',
    import_json_success: 'Monitors imported successfully',
    import_json_invalid: 'Invalid JSON file — expected an array of monitors',
    import_json_error: 'Failed to import monitors',
  },
  ...
  oncall: {
    title: 'On-call',
    subtitle: 'Rotations and escalation ladders. A rule pointing at a policy pages its rungs in order until someone acknowledges.',
    now_title: 'On call right now',
    nobody: 'Nobody on call',
    via_override: 'override',
    via_override_help: 'A one-off override is in effect, not the computed rotation.',
    schedules: 'Rotations',
    policies: 'Escalation policies',
    add_schedule: 'New rotation',
    edit_schedule: 'Edit rotation',
    delete_schedule: 'Delete rotation "{name}"?',
    delete_schedule_detail: 'Any escalation rung that pages this rotation will be deleted too.',
    schedule_deleted: 'Rotation deleted',
    add_policy: 'New policy',
    edit_policy: 'Edit policy',
    delete_policy: 'Delete policy "{name}"?',
    delete_policy_detail: 'Alert rules using it will fall back to their own channels — their alerts stop escalating, silently.',
    policy_deleted: 'Policy deleted',
    empty_schedules_title: 'No rotation yet',
    empty_schedules_text: 'A rotation decides who is on call at any moment. Escalation levels can then point at it instead of naming one person.',
    empty_policies_title: 'No escalation policy yet',
    empty_policies_text: 'A policy pages its levels in order until someone acknowledges. Attach one to an alert rule to use it.',
    disabled: 'disabled',
    enabled: 'Enabled',
    rotation: 'Rotation',
    rotation_daily: 'Daily',
    rotation_weekly: 'Weekly',
    rotation_custom: 'Every {n} days',
    rotation_custom_label: 'Every N days',
    rotation_length: 'Length (days)',
    handoff_time: 'Handoff time',
    handoff_at: 'handoff at {time}',
    handoff_help: 'The handoff happens at this time in the selected zone. Rotations are computed in calendar days, so it does not drift when the clocks change.',
    timezone: 'Timezone',
    start_at: 'Rotation starts',
    start_at_help: 'Anchor of the rotation: the first participant is on call from this moment.',
    participants: 'Participants, in shift order',
    add_participant: 'Add participant',
    no_participants_warning: 'A rotation with no participant designates nobody — levels pointing at it will be skipped.',
    n_participants: '{n} participant(s)',
    pick_user: 'Pick a user…',
    pick_channel: 'Pick a channel…',
    pick_schedule: 'Pick a rotation…',
    move_up: 'Move up',
    move_down: 'Move down',
    levels: 'Levels',
    add_level: 'Add level',
    no_levels: 'no level — falls back to the rule channels',
    ladder_rung: '+{n}min → {target}',
    no_levels_warning: 'A policy with no level escalates nothing: the alert falls back to the rule channels.',
    delay_minutes: 'Delay in minutes',
    delay_suffix: 'min after the previous level',
    delay_help: 'Each delay counts from the previous level firing, not from the incident opening — so inserting a level does not shift the ones above it.',
    repeat_count: 'Repeats',
    repeat_hint: '— replay the whole ladder N more times if nobody acknowledges',
  ...
  correlation: {
    ...
    button_title: 'Compare pushed application metrics around this incident',
  ...
  sweep: {
    ...
    role: 'Role',
    about: 'About',
    about_desc: 'Web monitoring platform with multi-probe geographic correlation',
    totp_qr_alt: 'TOTP QR code',
    logo_alt: 'Logo',
    or: 'or',
    palette_placeholder: 'Search monitors, navigate…',
    clear_recents: 'Clear recents',
    acknowledge: 'Acknowledge',
    no_results: 'No results',
    toast_paused: 'Paused {name}',
    toast_resumed: 'Resumed {name}',
    toast_pause_failed: 'Failed to update monitor',
    toast_acknowledged: 'Acknowledged {name}',
    toast_ack_failed: 'Failed to acknowledge',
    new_group: 'New group',
    group_name_placeholder: 'My Services',
    group_desc_placeholder: 'Optional description',
    for_status_url: '(for status page URL)',
    loading_chart: 'Loading chart…',
    no_data_points: 'No data points in this range.',
    role_viewer: 'Viewer',
    role_editor: 'Editor',
    role_admin: 'Admin',
    role_owner: 'Owner',
    ...
    schema_drift_title: 'API schema drift detection',
    enabled: 'Enabled',
    baseline_fingerprint: 'Current baseline fingerprint',
    baseline_none: 'No baseline set — next successful check will auto-set it',
    accept_latest: 'Accept latest',
    reset: 'Reset',
    schema_drift_hint: 'Enable to automatically detect JSON response structure changes.',
    select_monitor: '— select a monitor —',
    no_dns_changes: 'No changes detected in the loaded period',
    baseline_internal: 'Baseline — internal probes',
    baseline_internal_none: 'Not learned yet — waiting for a check from an internal probe',
    baseline_external: 'Baseline — external probes',
    baseline_external_none: 'Not learned yet — waiting for a check from an external probe',
    all_resolutions: 'All resolutions',
    time: 'Time',
    probe: 'Probe',
    returned_value: 'Returned value',
    value_differs: 'Differs from the previous check',
    skip_on_fail: 'skip on fail',
    view_screenshot: 'View screenshot',
    push_url_title: 'Push URL — custom metrics',
    endpoint: 'Endpoint',
    ...
    oidc_issuer_hint: '(e.g. https://accounts.google.com)',
  },
  ...
  monitor_detail: {
    ...
    health_engine_quorum: 'Quorum down',
    health_engine_all_up: 'all probes up',
    health_engine_rules: 'Active rules',
    health_engine_no_rules: 'No SLO rule configured for this monitor.',
    health_engine_on: 'Enabled',
    health_engine_off: 'Disabled',
    health_engine_disabled_hint: 'Enable the Global Health Engine to drive incidents from fleet-wide SLO rules instead of per-probe checks.',
    health_engine_enabled_toast: 'Health Engine enabled',
    health_engine_disabled_toast: 'Health Engine disabled',
    health_engine_add_rule: 'Add rule',
    health_engine_edit_rule: 'Edit SLO rule',
    health_engine_new_rule: 'New SLO rule',
    health_engine_rule_type: 'Rule type',
    health_engine_quorum_ratio: 'Quorum ratio',
    health_engine_p95_threshold: 'p95 threshold',
    health_engine_window: 'Window',
    health_engine_min_probes: 'Min probes',
    health_engine_cooldown: 'Cooldown',
    health_engine_rule_enabled: 'Rule enabled',
    health_engine_pause: 'Pause',
    health_engine_resume: 'Resume',
    health_engine_confirm_delete: 'Delete this SLO rule?',
    health_engine_divergent_label: 'Divergent probes (excluded from quorum)',
    fleet_p95: 'Fleet p95',
    ...
    postmortem_error: 'Error generating the post-mortem: {detail}',
    ...
    update_status_resolved: 'Resolved',
    sla_uptime: 'Uptime',
    ...
    custom_metrics_empty_title: 'No metrics pushed yet',
    custom_metrics_empty_text: 'Push business metrics from your application to chart them here — orders per minute, queue depth, anything a URL can send.',
    ...
    chart_alert_threshold: 'Alert: {ms}ms',
    chart_probes_up_suffix: '% probes UP',
    ...
    vs_prev_6h: 'vs prev. 6h',
    no_resolution_data: 'No resolution data yet',
    expected_value: 'expected: {value}',
    dns_change_history: 'Value change history',
    unlocated_probes: 'Unlocated probes',
    dns_alert_title: 'Create an alert rule?',
    dns_alert_desc: 'DNS Drift is enabled but no {code} alert rule exists for this monitor. Without a rule, DNS drifts will be detected but no notification will be sent.',
    dns_alert_channel: 'Notification channel',
    dns_alert_creating: 'Creating…',
    dns_alert_create: 'Create the alert rule',
    dns_alert_disable: 'Disable DNS Drift',
  },

  // Custom metrics dashboard
  metrics: {
    title: 'Metrics',
    no_data: 'No metrics pushed yet — use the push URL to send custom metrics.',
    current: 'Current',
    min: 'Min',
    max: 'Max',
    avg: 'Avg',
  ...
  probes: {
    ...
    version_outdated_tooltip: 'Probe v{probe} — server v{server}. Update this probe to apply the latest monitor config fields.',
    version_unknown: 'version unknown',
    version_unknown_tooltip: 'This probe predates version reporting (< 1.12) — it is likely outdated.',
    save: 'Save',
    saving: 'Saving…',
    ...
    health_load: 'Load',
    toast_enabled: 'Probe "{name}" enabled',
    toast_disabled: 'Probe "{name}" disabled',
    toast_deleted: 'Probe "{name}" deleted',
    toast_updated: 'Probe updated',
  },
  ...
  discovery: {
    ...
    // Targeting mode (plan E, E-2) — a source runs on one probe or on a
    // probe group. Immutable after creation, mirrors source_type.
    target_mode_label: 'Target',
    target_probe_option: 'A specific probe',
    target_group_option: 'A group of probes',
    group_label: 'Probe group',
    group_placeholder: '-- Choose a probe group --',
    pick_group_first: 'Choose a probe group first.',
    no_group_capabilities: '"{group}" has no probe declaring any discovery capability.',
    no_probe_groups: 'No probe group is visible to you yet — ask an administrator to grant access.',
    group_hint_docker: 'Runs on every probe in the group that declares this capability.',
    group_hint_port_scan: 'Runs on a single probe, elected automatically among capable group members.',
    group_hint_dns_zone: 'Runs on a single probe, elected automatically among capable group members.',
    group_capacity_warning: 'No probe in this group currently declares this capability — the source cannot run until one does.',
    group_target_label: 'Probe group: {group}',
    ...
    zone_label: 'Zone',
    zone_hint: 'Domain name to transfer, e.g. example.com.',
    resolver_label: 'Resolver',
    resolver_hint: 'IP address of the nameserver to request an AXFR zone transfer from — not a hostname.',
    record_types_label: 'Record types',
    record_types_hint: 'Which record types to report as discovered targets.',
  ...
  // Alert matrix (per-monitor conditions × channels grid)
  alert_matrix: {
    title: 'Alerting matrix',
    subtitle: 'Tick the channels that should fire for each condition. One save for everything.',
    subtitle_cards: 'Add a rule per condition, pick the channels that should fire.',
    save: 'Save alerting',
    condition: 'Condition',
    params: 'Parameters',
    enabled: 'Enabled',
    ...
    impact: {
      tooltip: 'Estimated {n} alert(s) over the last 30 days with this configuration.',
    },
    add_rule: 'Add rules',
    add_hint: 'Pick one or more conditions to add as alerting rules.',
    add_selected: 'Add',
    select_all: 'Select all',
    select_none: 'Clear',
    remove_rule: 'Remove this rule',
    templates: {
      trigger: 'Apply template',
      title: 'Alerting templates',
      hint: 'Pick a preset tuned for a common use case. Channels stay empty — you still decide where alerts fire.',
      apply: 'Apply',
      rules: 'rules',
      warn_replace: 'Applying a template replaces your current rules for this monitor.',
      system: 'Built-in',
      new: 'New template',
      empty: 'No templates for this check type yet.',
      section_title: 'Alerting templates',
      section_hint: 'Reusable presets available to everyone when configuring alerts on a monitor. System templates are read-only.',
      editor: {
        create_title: 'Create alerting template',
        edit_title: 'Edit alerting template',
        name: 'Name',
        description: 'Description',
        check_type: 'Check type',
        rules: 'Rules',
        no_rules: 'No rules yet. Add one below.',
        system_readonly: 'System templates cannot be modified.',
        confirm_delete: 'Delete this template? This cannot be undone.',
      },
    },
    empty_hint: 'No alerting rules yet. Add one to get notified when something goes wrong.',
    no_channels: 'You have no alert channels yet.',
    no_channels_short: 'No channels',
    create_channel: 'Create one',
    schedule: {
      title: 'Schedule',
      enable: 'Suppress alerts outside business hours',
      enable_hint: '(off = 24/7 alerting)',
      timezone: 'Timezone',
      start: 'Start',
      end: 'End',
      summary: '{days} day(s) · {start}–{end} ({tz})',
    },
    conditions: {
      any_down: 'Any probe reports the monitor down',
      all_down: 'All probes report down (global outage)',
      ssl_expiry: 'SSL certificate expiring soon',
      response_time_above: 'Response time above threshold (ms)',
      response_time_above_baseline: 'Response time above 7-day rolling baseline',
      anomaly_detection: 'Statistical anomaly on response time (z-score)',
      schema_drift: 'JSON API structure changed vs baseline',
      metric_above: 'Pushed metric above a threshold',
      metric_below: 'Pushed metric below a threshold',
      metric_absent: 'Pushed metric stopped reporting',
    },
    help_title: 'How it works',
    help: {
      any_down: 'Fires as soon as at least one probe reports the monitor as DOWN. Good default for early detection — noisy if you have flaky probes or regional glitches. Pairs well with "After" (min duration) to avoid single-check false alarms.',
      all_down: 'Fires only when every probe assigned to the monitor reports DOWN at the same time — a global outage. Low noise, high signal: ideal for paging channels like PagerDuty. Will not fire for partial/regional issues.',
      ...
      response_time_above: 'Fires when a single successful check exceeds the fixed threshold in milliseconds. Simple SLA check — use when you have a known latency budget. Does not account for time-of-day variance; for that use the baseline or anomaly conditions.',
      response_time_above_baseline: 'Fires when the response time exceeds (7-day average × baseline_factor). Uses a flat 7-day rolling average of successful checks. Catches general slowdowns without a hardcoded threshold. Needs at least a few days of data.',
      anomaly_detection: 'Compares each response time against the mean ± stddev of the last 7 days of successful checks, filtered to the same ±3h window of the day (day/night traffic patterns respected). Fires when (value − mean) / stddev exceeds the z-score threshold. Min 10 samples; default threshold 3.0 (≈ 0.3% false-positive rate).',
      ...
      metric_above: 'Fires when the latest value your application pushed to `POST /metrics/{monitor_id}` exceeds the threshold. Only a sample newer than the freshness window counts — a metric that went silent does not keep paging, it triggers "stopped reporting" instead. Evaluated every minute, not on push.',
      metric_below: 'Mirror of "above": fires when the latest pushed value falls under the threshold. For ratios and rates (cache hit rate, worker count, free disk). Silence never counts as zero.',
      metric_absent: 'Fires when nothing has been pushed for that metric for longer than the freshness window — the dead-agent case, invisible until now. Never fires for a metric name that was never pushed, so a typo stays quiet instead of paging forever.',
    },
  },
  ...
  alerts: {
    ...
    channel_form: {
      ...
      name: 'Name',
      name_placeholder: 'My Email Channel',
      type: 'Type',
      type_placeholder: 'Select type…',
      recipients: 'Recipients (comma-separated)',
      url: 'URL',
      secret_hmac: 'Secret (for HMAC signature)',
      secret_placeholder: 'Optional secret',
      webhook_url: 'Webhook URL',
      slack_hint: 'Create an Incoming Webhook in your Slack workspace.',
      discord_hint: 'Server Settings → Integrations → Webhooks → New Webhook.',
      mattermost_hint: 'System Console → Integrations → Incoming Webhooks.',
      teams_hint: 'Power Automate workflow with HTTP trigger → "Post adaptive card in a chat or channel". Legacy Office 365 connectors also work.',
      bot_token: 'Bot Token',
      fetch_chat_id: 'Fetch chat ID',
      telegram_hint: 'Send any message to your bot first, then click "Fetch chat ID".',
      connected_to: 'Connected to',
      chat_id: 'Chat ID',
      chat_id_placeholder: 'Auto-filled after fetch',
      integration_key: 'Integration Key (Routing Key)',
      pagerduty_hint: 'Find this key in your PagerDuty service (Events API v2).',
      severity: 'Severity',
      ...
      severity_info: 'Info',
      api_key: 'API Key',
      opsgenie_hint: 'Opsgenie API key (team settings).',
      region: 'Region',
      priority: 'Priority',
      ...
      priority_p4: 'P4 — Low',
      priority_p5: 'P5 — Info',
      signal_api_url: 'Signal REST API URL',
      signal_api_hint: 'URL of your signal-cli REST API instance.',
      sender_number: 'Sender Number',
      sender_number_hint: 'Phone number registered in signal-cli (E.164 format).',
      submitting: 'Adding…',
      submit: 'Add channel',
    },
    create_channel_first: 'Create at least one channel first to be able to configure rules.',
    scope_monitor: 'monitor',
    scope_group: 'group',
    rule_after_seconds: '· after {n}s',
    rule_renotify_minutes: '· re-alert {n}min',
    rule_digest_minutes: '· digest {n}min',
    rule_business_hours: '· 🕐 business hours',
    target_label: 'Target',
    target_monitor: 'Monitor',
    target_group: 'Group',
    target_locked: '(not editable)',
    select_placeholder: '-- Select --',
    condition_label: 'Condition',
    cond_any_down: 'Alert if at least one probe detects an outage',
    cond_all_down: 'Alert if all probes detect an outage (global outage)',
    cond_ssl_expiry: 'SSL certificate expiring soon',
    cond_response_time_above: 'Response / resolution time exceeded',
    cond_response_time_above_baseline: 'Response time > N× the 7-day average',
    cond_anomaly_detection: 'Anomaly detection (z-score)',
    cond_schema_drift: 'API schema drift',
    cond_group_metrics: 'Pushed application metrics',
    cond_metric_above: 'Pushed metric above a threshold',
    cond_metric_below: 'Pushed metric below a threshold',
    cond_metric_absent: 'Pushed metric stopped reporting',
    cond_short_any_down: 'Outage detected (any)',
    cond_short_all_down: 'Global outage (all)',
    cond_short_ssl_expiry: 'SSL expiry',
    cond_short_response_time_above: 'Response time >',
    cond_short_response_time_above_baseline: 'Response time > N× 7d avg',
    cond_short_anomaly_detection: 'Z-score anomaly',
    cond_short_schema_drift: 'API schema drift',
    cond_short_metric_above: 'Metric >',
    cond_short_metric_below: 'Metric <',
    cond_short_metric_absent: 'Metric silent',
    ...
    metric_window_help_absent: 'The alert fires once nothing has been pushed for longer than this. Set it above your push interval to avoid false alarms.',
    metric_delay_help: 'Pushed-metric rules are evaluated by a background loop roughly every {seconds}s, not at push time — so the alert can lag by that much.',
    rule_metric_window: '· window {n}s',
    baseline_factor_label: 'Factor (N×)',
    baseline_factor_hint: '— alert if response time > N × 7-day average',
    baseline_factor_help: 'Example: 3 → alert if the response time exceeds 3× the usual average over the last 7 days. Requires at least 24h of history.',
    zscore_label: 'Z-score threshold',
    ...
    digest_placeholder: 'e.g. 30',
    baseline_placeholder: 'e.g. 3',
    min_duration_label: 'Minimum duration before alert (s)',
    min_duration_hint: '— 0 = immediate',
    renotify_label: 'Re-notify every (min)',
    renotify_hint: '— empty = single alert',
    digest_label: 'Digest — batch alerts (min)',
    digest_off_hint: '— 0 = disabled',
    schedule_title: 'Business hours (optional)',
    schedule_help: 'Suppresses alerts outside the configured business hours.',
    schedule_suppress_label: 'Suppress alerts outside the configured hours',
    schedule_timezone: 'Timezone',
    schedule_days: 'Active days',
    schedule_start: 'Start time',
    schedule_end: 'End time',
    escalation_policy_label: 'Escalation policy',
    escalation_policy_none: 'None — notify the channels below',
    escalation_policy_hint: 'Pages the ladder in order until someone acknowledges. If it never reaches anyone, the alert falls back to the channels below — attaching a policy never makes a rule quieter.',
    channels_label: 'Channels',
    preview_title: 'Message preview',
    toast_rule_created_for: 'Alert rule created for {name} (>{ms}ms)',
    toast_error_creating_rule: 'Error creating rule',
    toast_error_saving_rule: 'Error saving rule',
    toast_channel_deleted: 'Channel "{name}" deleted',
  ...
  incidents: {
    ...
    type: 'Type',
    acknowledge: 'Acknowledge',
    unacknowledge: 'Remove acknowledgment',
    acknowledged: 'Acknowledged',
    acknowledged_by: 'Acknowledged by',
    ack_success: 'Incident acknowledged.',
    unack_success: 'Acknowledgment removed.',
    bulk_ack: 'Acknowledge all',
    bulk_ack_success: '{count} incident(s) acknowledged',
    mttd: 'MTTD',
    mttr: 'MTTR',
    mttd_tooltip: 'Mean Time to Detect — delay between first failure and incident creation',
    mttr_tooltip: 'Mean Time to Resolve — total incident duration',
    sla_metrics: 'SLA Metrics',
    correlated_summary: '{count} correlated incidents',
  ...
  auth: {
    ...
    mfa_hint: 'Enter the 6-digit code from your authenticator app.',
    mfa_recovery_hint: 'Enter one of your recovery codes (XXXX-XXXX).',
    mfa_code: 'Verification code',
    mfa_verify: 'Verify',
    mfa_verifying: 'Verifying…',
    mfa_use_recovery: 'Use a recovery code',
    mfa_use_totp: 'Use authenticator code',
  ...
  settings: {
    ...
    preferences_desc: 'Display options that apply to your account on any device.',
    timezone_label: 'Timezone',
    timezone_auto: 'Automatic — use this browser ({tz})',
    timezone_current: 'Dates are shown in',
    timezone_now: 'right now:',
    ...
    biometric_off: 'Disabled',
    biometric_enable: 'Enable biometric unlock',
    biometric_disable: 'Disable biometric unlock',
    biometric_reason_enable: 'Enable biometric unlock for WhatIsUp',
    biometric_no_session: 'No active session to protect — sign in first.',
    biometric_enroll_failed: 'Biometric enrollment failed or was cancelled.',
    ...
    extension_desc: 'Record browser scenarios directly from any website and send them to WhatIsUp as monitoring checks.',
    extension_download: 'Download Extension',
    extension_downloading: 'Preparing…',
    extension_install_title: 'Installation',
    extension_install_step1: 'Download the ZIP file using the button above.',
    extension_install_step2: 'Unzip the archive to a folder on your computer.',
    extension_install_step3: 'Open {bold1} in Chrome (or {bold2} in Edge).',
    extension_install_step3_bold1: 'chrome://extensions',
    extension_install_step3_bold2: 'edge://extensions',
    extension_install_step4: 'Enable {bold} (top-right toggle).',
    extension_install_step4_bold: 'Developer mode',
    extension_install_step5: 'Click {bold} and select the unzipped folder.',
    extension_install_step5_bold: 'Load unpacked',
    extension_install_step6: 'The server URL is pre-configured. Just paste your API key in the extension options.',
    extension_features_title: 'What it records',
    extension_features: 'Clicks, form fills, navigation, hovers, scrolls, drag & drop, file uploads. Supports assertions, Playwright export, and editing existing scenarios.',
    security: {
      title: 'Two-factor authentication',
      desc: 'Add a second step at sign-in using a TOTP authenticator app (Google Authenticator, Authy, 1Password…).',
      totp_on: 'Enabled — a verification code is required at sign-in',
      totp_off: 'Disabled',
      totp_enable: 'Enable 2FA',
      totp_disable: 'Disable 2FA',
      totp_enabled_toast: 'Two-factor authentication enabled',
      totp_disabled_toast: 'Two-factor authentication disabled',
      setup_title: 'Set up two-factor authentication',
      setup_desc: 'Scan this QR code with your authenticator app, then enter the generated code to confirm.',
      setup_qr_fallback: 'Could not render the QR code. Open this link in your authenticator app:',
      setup_manual: 'Or enter this secret manually:',
      setup_code_label: 'Authenticator code',
      setup_confirm: 'Confirm & enable',
      invalid_code: 'Invalid code, please try again',
      error_generic: 'Something went wrong, please try again',
      recovery_title: 'Save your recovery codes',
      recovery_warning: 'Store these codes somewhere safe. Each can be used once if you lose access to your authenticator. They will not be shown again.',
      recovery_saved: "I've saved them",
      copy_failed: 'Could not copy to clipboard',
      disable_title: 'Disable two-factor authentication',
      disable_desc: 'Confirm with your password and a current code (or a recovery code) to turn off 2FA.',
      disable_confirm: 'Disable 2FA',
      sessions_title: 'Active sessions',
      sessions_desc: 'Devices currently signed in to your account.',
      sessions_empty: 'No other active sessions.',
      sessions_error: 'Could not load sessions',
      session_current: 'This device',
      session_unknown_ua: 'Unknown device',
      session_revoke: 'Revoke',
      session_revoke_confirm: 'Sign this device out of your account?',
      session_revoked_toast: 'Session revoked',
      sessions_revoke_all: 'Sign out all other sessions',
      sessions_revoke_all_confirm: 'Sign out every other device? Your current session stays active.',
      sessions_revoked_all_toast: 'All other sessions signed out',
    },
  },
  ...
  apiKeys: {
    ...
    empty: 'Create one to authenticate scripts or the recorder extension.',
    ...
    scope_full_desc: 'Read and modify',
    scope_read: 'Read-only',
    scope_read_desc: 'Cannot modify anything',
    read_only: 'Read-only',
    ...
    toast_revoked: 'Key "{name}" revoked',
  ...
  maintenance: {
    ...
    empty_desc: 'Schedule maintenance windows to suppress alerts during planned downtime.',
    add: 'Add window',
    modal_title: 'New maintenance window',
    modal_edit_title: 'Edit maintenance window',
    no_windows: 'No maintenance windows',
    starts: 'Starts',
    ends: 'Ends',
    active: 'Active',
    alerts_suppressed: 'Alerts suppressed',
    alerts_not_suppressed: 'alerts not suppressed',
    ...
    name_placeholder: 'e.g. Weekly deployment',
    description_label: 'Description',
    description_placeholder: 'Reason for this maintenance window…',
    monitor_label: 'Affected monitor',
    monitor_placeholder: 'Select a monitor',
  ...
  public: {
    ...
    subscribed: 'Almost there — check your inbox to confirm the subscription.',
    subscription_confirmed: "Subscription confirmed. You'll receive status updates.",
    link_invalid: 'This link is invalid or has already been used.',
    ...
    no_updates_posted: 'No updates posted yet.',
    subscribe_desc: 'Receive email notifications for incidents and restorations.',
  ...
  // Groups
  groups: {
    subtitle: 'Organize monitors and create public status pages',
    create: 'New Group',
    empty: 'No groups yet',
    empty_desc: 'Groups let you organize monitors and create public status pages.',
    no_description: 'No description',
    private: 'Private',
    manage: 'Manage',
    confirm_delete: 'Delete group "{name}"?',
    ...
    public_logo_url: 'Logo URL (public page)',
    public_accent_color: 'Accent color (public page)',
    public_custom_css: 'Custom CSS',
    public_custom_css_hint: 'Injected into the public status page (advanced)',
  },
  ...
  templates: {
    ...
    empty_desc: 'Create reusable blueprints to spin up monitors quickly.',
    public_badge: 'Public',
    shared_badge: 'Shared',
    ...
    create: 'Create',
    form_name_placeholder: 'e.g. REST API monitor',
    name_override_placeholder: 'Custom monitor name',
    invalid_json: 'Invalid JSON: {msg}',
    error_saving: 'Error saving template',
    error_deleting: 'Error deleting template',
    error_applying: 'Error applying template: {detail}',
    applied: 'Monitor "{name}" created',
  },

  // Teams
  teams: {
    title: 'Teams',
    subtitle: 'Manage teams and member roles',
    create: 'Create team',
    edit: 'Edit team',
    name: 'Team name',
    slug_hint: 'optional',
    ...
    confirm_delete_team: 'Delete team',
    confirm_remove_member: 'Remove',
    error_create: 'Error creating team',
    error_edit: 'Error updating team',
    error_delete: 'Error deleting',
    error_add_member: 'Error adding member',
    error_update_role: 'Error updating role',
  },
  ...
  admin: {
    ...
    subtitle: 'Manage users, teams, monitors and probe groups',
    tab_users: 'Users',
    tab_teams: 'Teams',
    tab_monitors: 'Monitors',
    tab_probe_groups: 'Probe groups',
    tab_oidc: 'SSO / OIDC',
    // Users tab
    user_count: '{n} user(s)',
    add_user: 'Add user',
    ...
    can_create_monitors: 'Can create monitors',
    edit_user_title: 'Edit — {name}',
    create_user_title: 'Add user',
    label_email: 'Email *',
    label_username: 'Username (optional)',
    label_full_name: 'Full name',
    label_password: 'Password *',
    label_new_password: 'New password (leave empty to keep current)',
    placeholder_username: 'Auto-generated',
    perm_can_create_monitors: 'Can create monitors',
    perm_can_create_monitors_desc: 'Allow this user to create monitors',
    perm_is_admin: 'Administrator',
    perm_is_admin_desc: 'Full access to platform administration',
    perm_is_admin_desc_short: 'Full access to administration',
    toggle_active: 'Active account',
    error_create: 'Error creating user',
    error_edit: 'Error updating user',
    confirm_delete_user: 'Delete user',
    confirm_delete_msg: 'Delete user {name}? This action is irreversible.',
    // Teams tab
    team_count: '{n} team(s)',
    create_team: 'Create team',
    no_teams: 'No teams. Create one to get started.',
    ...
    label_role: 'Role',
    no_members: 'No members',
    confirm_team_action: 'Confirm',
    remove_member_prefix: 'Remove',
    remove_member_suffix: 'from the team?',
    delete_team_prefix: 'Delete team',
    delete_team_suffix: '? This action is irreversible.',
    // Monitors tab
    monitor_count: '{n} monitor(s)',
    col_owner: 'Owner',
    col_name: 'Name',
    col_type: 'Type',
    col_url: 'URL',
    no_monitors: 'No monitors',
    monitor_enabled: 'Active',
    monitor_disabled: 'Disabled',
    // Probe groups tab
    group_count: '{n} group(s)',
    create_group: 'Create group',
    no_groups: 'No probe groups',
    create_group_title: 'Create probe group',
    ...
    group_probes: '{n} probe(s)',
    group_users: '{n} user(s)',
    section_probes: 'Probes',
    no_probes_in_group: 'No probes in this group.',
    add_probe_placeholder: '-- Add a probe --',
    add_btn: 'Add',
    section_users: 'Users with access',
    no_users_in_group: 'No users.',
    add_user_placeholder: '-- Grant access to a user --',
    confirm_delete_group: 'Confirm deletion',
    confirm_delete_group_msg: 'Delete group {name}? This action is irreversible.',
    deleting: 'Deleting…',
    saving: 'Saving…',
    save_btn: 'Save',
    // OIDC tab
    oidc_env_warning: 'Current configuration read from environment variables. Saving here will create a database configuration that takes precedence.',
    oidc_enable_label: 'Enable SSO (OIDC)',
    oidc_enable_desc: 'Shows the "SSO login" button on the login page',
    oidc_issuer_label: 'Issuer URL',
    oidc_client_id_label: 'Client ID',
    oidc_client_secret_label: 'Client Secret',
    oidc_client_secret_set: '(secret saved — leave empty to keep)',
    oidc_client_secret_unset: '(not set)',
    oidc_redirect_uri_label: 'Redirect URI',
    oidc_redirect_uri_hint: '(leave empty for auto-detection)',
    oidc_scopes_label: 'Scopes',
    oidc_auto_provision_label: 'Auto-provisioning',
    oidc_auto_provision_desc: 'Automatically create a local account on first SSO login',
    oidc_saving: 'Saving…',
    oidc_save: 'Save',
    oidc_saved: 'Configuration saved.',
  },
  ...
  public_page: {
    not_found_title: 'Status page not found',
    not_found_desc: 'No public page matches this URL.',
    no_data: 'No data available',
    no_monitors: 'No monitors in this group yet.',
  },
  ...
  group_detail: {
    ...
    group_monitors: 'Group monitors',
    add_monitor: 'Add a monitor',
    no_monitors: 'No monitors in this group.',
    url_host: 'URL / Host',
    remove: 'Remove',
    add_monitor_title: 'Add a monitor',
    select_monitor_hint: 'Select a monitor to add to this group.',
    choose_monitor: '-- Choose a monitor --',
    error_load: 'Error loading group',
    error_save_customization: 'Failed to save customization',
  ...
  create_monitor: {
    ...
    interval: 'Interval (s)',
    timeout: 'Timeout (s)',
    type_http_desc: 'HTTP/HTTPS endpoint check',
  ...
  graph: {
    ...
    no_dependencies: 'No monitors or dependencies to display',
    tooltip_type: 'Type:',
    tooltip_status: 'Status:',
  },

  // Runbook
  // Scenario builder. Keyboard key names (Tab, Enter, Escape…) and DOM
  // attribute names (href, src) are deliberately left untranslated: they name
  // physical keys and HTML attributes, identical in every locale.
  scenario: {
    variables: 'Variables',
    variables_hint: 'usable with',
    add_variable: 'Add variable',
    variable_name_placeholder: 'NAME',
    variable_value_placeholder: 'value',
    mark_secret: 'Mark as secret (hidden)',
    remove_variable: 'Remove variable',
    steps: 'Steps',
    step_count: '{n} step(s)',
    templates: 'Templates',
    import: 'Import',
    import_title: 'Import steps from a JSON file',
    export: 'Export',
    export_title: 'Export steps as JSON',
    import_error_array: 'The JSON file must contain an array of steps.',
    import_error_read: 'Could not read the JSON file.',
    choose_template: 'Choose a template to pre-fill steps:',
    section_title_placeholder: 'Section title…',
    move_step_up: 'Move step up',
    move_step_down: 'Move step down',
    remove_step: 'Remove step',
    step_label_placeholder: 'Description (optional)',
    add_step: 'Add a step',
    options: 'Options',
    step_timeout_placeholder: 'Timeout ms (inherits global if empty)',
    continue_on_fail: 'Continue if this step fails',
    // Step type groups + labels — shared by the type selector and the palette.
    ...
    // Shorter variants for the palette tiles.
    palette: {
      wait_element: 'Wait elem.',
      wait_time: 'Wait',
      assert_visible: 'Visible',
    },
    selector_placeholder: 'CSS selector',
    selector_click_placeholder: 'CSS selector e.g. button#submit, .btn-login',
    selector_fill_placeholder: 'CSS selector e.g. input[name=email], #password',
    selector_scroll_placeholder: 'CSS selector (leave empty to scroll by position)',
    selector_press_placeholder: 'CSS selector (leave empty to press on focused element)',
    selector_type_placeholder: 'CSS selector (leave empty to type on focused element)',
    option_value_placeholder: 'Option value',
    state_visible: 'visible',
    state_hidden: 'hidden',
    state_attached: 'attached',
    state_detached: 'detached',
    timeout_placeholder: 'Timeout ms (default: 5000)',
    duration_placeholder: 'Duration in ms e.g. 1000',
    mode_contains: 'contains',
    mode_equals: 'equals',
    expected_text_placeholder: 'Expected text',
    expected_url_placeholder: 'Expected URL',
    custom_key_placeholder: 'Or custom key e.g. Control+a',
    screenshot_name_placeholder: 'Name e.g. after-login',
    extract_variable_placeholder: 'VARIABLE_NAME',
    attr_text: 'text (content)',
    attr_value: 'value (input)',
    attr_custom: 'custom attribute',
    tmpl: {
      login_title: 'Login form',
      login_desc: 'Opens a login page, fills email + password, verifies redirect.',
      search_title: 'Search + verify',
      search_desc: 'Performs a search and verifies the presence of results.',
      contact_title: 'Contact form',
      contact_desc: 'Fills and submits a contact form, verifies the confirmation.',
      cart_title: 'Shopping cart',
      cart_desc: 'Adds a product to the cart and verifies its contents.',
    },
    replace_steps_confirm: 'Replace existing steps?',
  },
  ...
  tls_fleet: {
    title: 'TLS Fleet',
    subtitle: 'Latest TLS audit per monitored HTTPS endpoint — grade, version, expiry.',
    grade_below: 'Grade worse than',
    expires_within: 'Expires within (days)',
    san_mismatch_only: 'SAN mismatch only',
    export_csv: 'Export CSV',
    empty: 'No TLS audit data yet — run a check on an HTTPS monitor first.',
    col_monitor: 'Monitor',
    col_grade: 'Grade',
    col_tls: 'TLS',
    col_cipher: 'Cipher',
  ...
  bgp: {
    show_path: 'Show BGP path',
    title: 'BGP looking-glass',
    target_ip: 'Target IP',
    rrc_count: 'Vantage points',
    cached: 'cached',
    col_rrc: 'RRC',
    col_location: 'Location',
    col_peer_asn: 'Peer ASN',
    col_as_path: 'AS path',
    error: 'BGP looking-glass unavailable',
    not_partition: 'Available only on network_partition_* incidents.',
  },
}
