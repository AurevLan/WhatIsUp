export default {
  ...
  monitors: {
    ...
    dns_drift: {
      ...
      consistency: 'Cross-probe consistency',
      consistency_desc: 'Alert when different probes resolve different IPs.',
      split_horizon: 'Allow split-horizon',
      split_horizon_desc: 'Expected split DNS — do not alert on probe divergence.',
