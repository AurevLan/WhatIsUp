export default {
  ...
  empty: {
    ...
    maintenance_text: 'Schedule a suppression window to silence alerts during planned downtime or a known-noisy event.',
  ...
  apiKeys: {
    ...
    empty: 'Create one to authenticate scripts or third-party integrations.',
    info_title: 'API keys allow external access without a JWT session.',
    info_body: 'Use them in scripts, CI pipelines, or third-party integrations.',
    key_name: 'Key name',
    key_name_placeholder: 'e.g. Monitoring script, CI pipeline…',
    scopes: 'Permissions',
  ...
  maintenance: {
    // Plan cap v2, 6d — this used to be two separate concepts (maintenance
    // windows + alert silences), now one "suppression window" with an
    // is_maintenance toggle. Keys kept under the `maintenance` namespace to
    // minimize churn; wording updated to the merged concept.
    title: 'Suppressions',
    subtitle: 'Silence alerts for a bounded window — maintenance or a plain mute',
    empty_desc: 'Schedule a suppression window to silence alerts during planned downtime or a known-noisy event.',
    add: 'Add window',
    modal_title: 'New suppression window',
    modal_edit_title: 'Edit suppression window',
    no_windows: 'No suppression windows',
    starts: 'Starts',
    ends: 'Ends',
    active: 'Active',
    alerts_suppressed: 'Alerts suppressed',
    alerts_not_suppressed: 'alerts not suppressed',
    suppress_alerts_label: 'Suppress sibling alerts when the whole group is down',
    confirm_delete: 'Delete this suppression window?',
    confirm_delete_detail: 'This action is irreversible.',
    ...
    description_placeholder: 'Reason for this window…',
    monitor_label: 'Affected monitor',
    monitor_placeholder: 'Select a monitor',
    monitor_none: 'None (all monitors)',
    monitor_none_hint_silence: 'Leave empty to silence every monitor you own.',
    error_required: 'Name, start and end date are required.',
    error_target_required: 'A maintenance window needs a monitor or a group — uncheck "planned maintenance" for a catch-all silence instead.',
    schedule_maintenance: 'Schedule suppression',
    ...
    is_maintenance_label: 'Count as planned maintenance (excluded from uptime)',
    is_maintenance_hint_on: 'Downtime during this window is excluded from uptime, and it may appear on the public status page.',
    is_maintenance_hint_off: 'A plain silence: the incident still opens and counts normally — only notifications are muted.',
    kind_maintenance: 'Maintenance',
    kind_silence: 'Silence',
    preset_30m: '+30m',
    preset_1h: '+1h',
    preset_4h: '+4h',
    preset_tomorrow: 'Until tomorrow',
  },
  ...
  scenario: {
    ...
    templates: 'Templates',
    import: 'Import',
    import_title: 'Import a JSON file (export) or a playwright codegen script',
    export: 'Export',
    ...
    import_error_script: 'No recognized instruction in this file — expected a script generated by `playwright codegen`.',
    import_error_script_empty: 'The script was read but no step could be extracted from it.',
    import_script_warnings: 'Import finished with {n} warning(s) — review the generated selectors before saving.',
