...
def upgrade() -> None:
    op.add_column(
        "monitors", sa.Column("heartbeat_slug", sa.String(80), nullable=True, unique=True)
    )
    op.add_column("monitors", sa.Column("heartbeat_interval_seconds", sa.Integer(), nullable=True))
    op.add_column(
        "monitors",
        sa.Column("heartbeat_grace_seconds", sa.Integer(), nullable=True, server_default="60"),
    )
    op.add_column(
        "monitors", sa.Column("last_heartbeat_at", sa.DateTime(timezone=True), nullable=True)
    )
